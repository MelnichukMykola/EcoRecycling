...
export default function Nav() {
    ...
    const displayName = (user?.displayName && user.displayName.trim()) || (user?.email ? user.email.split("@")[0] : "");
    ...
    return (
        <header className={styles.header}>
            ...
            <div className={styles.actions}>
                ...
                {user && (
                    <button type="button" onClick={signOutUser} className={styles.iconBtn} aria-label="Wyloguj" title="Wyloguj">
