...
export default function RecyclingCalculator() {
  ...
  const currentMaterial = MATERIAL_VALUES.find(
  ...
  return (
    <div className={s.calculatorContainer}>
      ...
      <p className={s.description}>
        Wpisz wagę oddanych materiałów, aby natychmiast obliczyć, ile EcoCoins
        otrzymasz!
      </p>
      ...
      <div className={s.form}>
        ...
        <div className={s.resultBox}>
          <div className={s.resultText}>
            Otrzymasz:
            <strong className={s.coinsValue}>{resultCoins} EcoCoins</strong>
          </div>
